        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TemplateSlots_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateSlots_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ForkScheduleId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Schedules_ForkScheduleId",
                        column: x => x.ForkScheduleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    EndTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    Type_ = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleAssignments", x => new { x.AssignmentId, x.ScheduleId });
                    table.ForeignKey(
                        name: "FK_ScheduleAssignments_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_ForkScheduleId",
                table: "Schedules",
                column: "ForkScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateSlots_DepartmentId",
                table: "TemplateSlots",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateSlots_UserId",
                table: "TemplateSlots",
                column: "UserId");
